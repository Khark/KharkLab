...
public class MemberController {
	 ...
	 * System.out.println("들어는오나?"); ModelAndView mav = new ModelAndView();
	 * mav.setViewName("member/info"); mav.addObject("dto",
	 * memberService.viewMember(userId)); return mav;
	 * 
	 * }
	 */
	@RequestMapping(value = "/view", method = RequestMethod.GET)
	...
	public ModelAndView list(HttpServletRequest request) throws Exception {
		...
		/*
		 * mav.setViewName("member/info"); mav.addObject("dto",
		 * memberService.viewMember(userName));
		 */
